...
class SummerProductWidget extends StatefulWidget {
  ...
  @override
  State<SummerProductWidget> createState() => _SummerProductWidgetState();
}

class _SummerProductWidgetState extends State<SummerProductWidget> {
