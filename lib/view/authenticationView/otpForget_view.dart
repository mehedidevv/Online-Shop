...
import 'package:shop_app/view/authenticationView/resetPassword_view.dart';
...
class OtpVerifyAccount extends StatefulWidget {
  OtpVerifyAccount({super.key});

  @override
  State<OtpVerifyAccount> createState() => _OtpVerifyAccountState();
}

class _OtpVerifyAccountState extends State<OtpVerifyAccount> {
